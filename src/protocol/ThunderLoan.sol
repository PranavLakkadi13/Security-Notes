    ...
    OracleUpgradeable
{
    ...
    /*//////////////////////////////////////////////////////////////
                            STATE VARIABLES
    //////////////////////////////////////////////////////////////*/
    // e: it is the mapping from deposited(liquidity) token -> shares token contract
    mapping(IERC20 => AssetToken) public s_tokenToAssetToken;

    // The fee in WEI, it should have 18 decimals. Each flash loan takes a flat fee of the token price.
    uint256 private s_feePrecision; // @audit y not constant or immutable?
    ...
    /*//////////////////////////////////////////////////////////////
                           EXTERNAL FUNCTIONS
    //////////////////////////////////////////////////////////////*/
    // @audit-info add a zero address check
    function initialize(address tswapAddress) external initializer {
        __Ownable_init(msg.sender);
        __UUPSUpgradeable_init();
        __Oracle_init(tswapAddress);
        s_feePrecision = 1e18;
        // @audit verify if the fee is correct value? it looks incorrect
    ...
    function updateFlashLoanFee(uint256 newFee) external onlyOwner {
        ...
        // @audit must emit event for this
